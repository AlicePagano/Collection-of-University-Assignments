...
HD_PWD='/home/student08/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_asym.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_asym.tcl
