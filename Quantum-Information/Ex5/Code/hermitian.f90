...
program demo
    ...
    complex(8), dimension(:), allocatable :: AP  ! package matrix
    ...
    file_name = trim('hermitian_data-'//Levelchar//'.dat')
    ...
    do tt=1,ntime
        ...
        ! Random initialize hermitian matrix A
        ...
        ! add data of this execution to spacing vector
        ll = (tt-1)*(n-1) + 1
        uu = tt*(n-1)
    ...
    !print *, minimum
    !print *, maximum
    file_name = trim('hermitian-global-'//Levelchar//'.dat')
    ...
    !print *, minimum
    !print *, maximum
    file_name = trim('hermitian-local-'//Levelchar//'.dat')
